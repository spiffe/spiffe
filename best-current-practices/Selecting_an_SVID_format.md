...
## Abstract
The SPIFFE standard specifies multiple compliant SVID formats. Selection of the most appropriate for use is dependent on numerous factors, including but not limited to: desired security properties, workload-to-workload networking infrastructure, interoperability, and SDK availability \& maturity.
